...
def ToDo(root):
    ...
    img = Image.open("C:\Programming\Python\Tkinter\Final_Project\Images\plus_icon.png")
    ...
    img2 = Image.open("C:\Programming\Python\Tkinter\Final_Project\Images\del_icon.png")
    ...
    img3 = Image.open("C:\Programming\Python\Tkinter\Final_Project\Images\done_icon.png")
